...
LEFT JOIN PTC_CTE PTC 
ON SRC.PTC_DMN_ID = PTC.PTC_DMN_ID
{% if delta %}
...
{% endif %}
ON PTC.PTC_DMN_ID = PTC_MERGE.PTC_DMN_ID
WHERE UPPER(SRC.SRC_RK_CD) = 'OMNI' -- Filter participant_id where provider_source_system_instance_id = 1
{% if delta %}
